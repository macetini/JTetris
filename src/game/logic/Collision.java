...
/**
 * Utility class for collision detection in the Tetris game. Provides methods to
 * check for collisions with the grid, floor, and walls.
 */
public class Collision {
	 ...
	 * @return true if a collision with the floor occurs, false otherwise
	 */
	public boolean collidesWithCeil(MovingPieceData newPiece) {
		Point newPosition = newPiece.getPosition();
		int[][] currentShape = newPiece.getShape();
